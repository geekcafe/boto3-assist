...
class DecimalConversionExample:
    ...
    def demonstrate_decimal_conversion_utility(self):
        ...
        nested_data = {
            ...
            "metadata": {"tax": Decimal("8.00"), "shipping": Decimal("9.99")},
        }
    ...
    def demonstrate_safe_decimal_conversion(self):
        ...
        for value in test_values:
            ...
            print(
                f"  Input: {value} ({type(value).__name__}) -> Result: {result} ({type(result).__name__})"
            )
    ...
    def demonstrate_formatting(self):
        ...
        for decimal_val in test_decimals:
            formatted_2 = DecimalConversionUtility.format_decimal_for_display(
                decimal_val, precision=2
            )
            formatted_3 = DecimalConversionUtility.format_decimal_for_display(
                decimal_val, precision=3
            )
