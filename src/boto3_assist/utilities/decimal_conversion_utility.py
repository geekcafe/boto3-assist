...
class DecimalConversionUtility:
    ...
    def convert_decimals_to_native_types(data: Any) -> Any:
        ...
        if isinstance(data, dict):
            ...
            return [
                DecimalConversionUtility.convert_decimals_to_native_types(item) for item in data
            ]
    ...
    def convert_native_types_to_decimals(data: Any) -> Any:
        ...
        if isinstance(data, dict):
            ...
            return [
                DecimalConversionUtility.convert_native_types_to_decimals(item) for item in data
            ]
