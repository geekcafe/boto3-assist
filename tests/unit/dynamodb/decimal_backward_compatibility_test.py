...
class VoteSummaryLegacy(DynamoDBModelBase):
    ...
    def choice_averages(self) -> Dict[str, float]:
        ...
        return {
            k: float(v) if isinstance(v, Decimal) else v for k, v in self._choice_averages.items()
        }
...
class TestDecimalBackwardCompatibility(unittest.TestCase):
    ...
    def test_multiple_models_produce_consistent_results(self):
        ...
        dynamodb_item_votes = {
            "choice_averages": {"product_a": Decimal("4.5"), "product_b": Decimal("3.8")}
        }
    ...
    def test_float_property_automatic_conversion(self):
        ...
        dynamodb_item = {"conversion_rate": Decimal("0.15")}
    ...
    def test_list_pattern_automatic_conversion(self):
        ...
        dynamodb_item = {"scores": [Decimal("1.5"), Decimal("2.7"), Decimal("3.9")]}
    ...
    def test_nested_structure_automatic_conversion(self):
        ...
        dynamodb_item = {
            "metrics": {
                "performance": {"avg_load_time_ms": Decimal("185.5"), "requests": Decimal("1000")},
    ...
    def test_map_with_item_only_response(self):
        ...
        dynamodb_response = {
            "Item": {"id": "prod_789", "name": "Another Product", "price": Decimal("39.99")}
        }
    ...
    def test_none_values_preserved(self):
        ...
        data_with_none = {"id": "prod_222", "name": None, "price": Decimal("9.99")}
    ...
    def test_boolean_values_not_affected(self):
        ...
        data = {"enabled": True, "count": Decimal("5")}
    ...
    def test_string_values_not_affected(self):
        ...
        data = {"id": "prod_333", "name": "Test Product Name", "price": Decimal("14.99")}
    ...
    def test_comparison_operations_work(self):
        ...
        data = {"price": Decimal("19.99"), "cost": Decimal("12.00"), "tax_rate": Decimal("0.08")}
