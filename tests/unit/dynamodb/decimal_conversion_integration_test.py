...
class TestDynamoDBDecimalConversion(unittest.TestCase):
    ...
    def test_dynamodb_apply_decimal_conversion(self):
        ...
        response_with_decimals = {
            "Item": {"price": Decimal("49.99"), "quantity": Decimal("20")},
            "Count": 1,
        }

        result = self.dynamodb._apply_decimal_conversion(response_with_decimals)

        expected = {"Item": {"price": 49.99, "quantity": 20}, "Count": 1}
    ...
    def test_dynamodb_conversion_disabled(self):
        ...
        response_with_decimals = {"Item": {"price": Decimal("49.99"), "quantity": Decimal("20")}}
    ...
    def test_get_method_applies_decimal_conversion(self, mock_resource):
        ...
        mock_table.get_item.return_value = {
            "Item": {"id": "test_id", "price": Decimal("99.99"), "quantity": Decimal("3")}
        }

        result = self.dynamodb.get(key={"id": "test_id"}, table_name="test_table")
    ...
    def test_query_method_applies_decimal_conversion(self, mock_resource):
        ...
        mock_table.query.return_value = {
            "Items": [
                {"id": "item1", "price": Decimal("19.99"), "quantity": Decimal("2")},
                {"id": "item2", "price": Decimal("29.99"), "quantity": Decimal("1")},
            ],
            "Count": 2,
        }
        ...
        result = self.dynamodb.query(key=Key("pk").eq("test"), table_name="test_table")
            ...
            "Items": [
                {
                    ...
                    "metadata": {"tax": Decimal("16.00"), "shipping": Decimal("9.99")},
                }
            ]
        }
    ...
    def test_error_response_handling(self):
        ...
        error_response = {"exception": "Some error occurred"}
