...
class TestUpdateExpressionsSET(unittest.TestCase):
    ...
    def test_set_single_attribute(self):
        ...
        # Create item
        item = {"pk": "user#001", "sk": "user#001", "name": "Alice", "email": "alice@old.com"}
        ...
        # Verify update
        response = self.db.get(key={"pk": "user#001", "sk": "user#001"}, table_name=self.table_name)
    ...
    def test_set_multiple_attributes(self):
        ...
        # Create item
        item = {"pk": "user#002", "sk": "user#002", "name": "Bob", "age": 25, "city": "NYC"}
        self.db.save(item=item, table_name=self.table_name)
        ...
        # Verify updates
        response = self.db.get(key={"pk": "user#002", "sk": "user#002"}, table_name=self.table_name)
    ...
    def test_set_with_reserved_word(self):
        ...
        # Create item
        item = {"pk": "item#003", "sk": "item#003", "name": "Widget", "status": "pending"}
        self.db.save(item=item, table_name=self.table_name)
        ...
        # Verify update
        response = self.db.get(key={"pk": "item#003", "sk": "item#003"}, table_name=self.table_name)
    ...
    def test_set_with_math_expression(self):
        ...
        item = {"pk": "counter#004", "sk": "counter#004", "count": 10, "price": 100}
        self.db.save(item=item, table_name=self.table_name)
        ...
        response = self.db.get(
            key={"pk": "counter#004", "sk": "counter#004"}, table_name=self.table_name
        )
...
class TestUpdateExpressionsADD(unittest.TestCase):
    ...
    def test_add_atomic_counter(self):
        ...
        # Create item with counter
        item = {"pk": "post#001", "sk": "post#001", "title": "My Post", "views": 0}
        self.db.save(item=item, table_name=self.table_name)
        ...
        # Verify increment
        response = self.db.get(key={"pk": "post#001", "sk": "post#001"}, table_name=self.table_name)
    ...
    def test_add_to_set(self):
        ...
        item = {"pk": "user#002", "sk": "user#002", "name": "Bob", "tags": {"premium"}}
        self.db.save(item=item, table_name=self.table_name)
...
class TestUpdateExpressionsREMOVE(unittest.TestCase):
    ...
    def test_remove_attribute(self):
        ...
        # Verify removal
        response = self.db.get(key={"pk": "doc#001", "sk": "doc#001"}, table_name=self.table_name)
...
class TestUpdateExpressionsComplex(unittest.TestCase):
    ...
    def test_set_add_remove(self):
        ...
        response = self.db.get(key={"pk": "item#002", "sk": "item#002"}, table_name=self.table_name)
        self.assertEqual(response["Item"]["status"], "active")
...
class TestUpdateExpressionsReturnValues(unittest.TestCase):
    ...
    def test_return_all_new(self):
        ...
        # Create item
        item = {"pk": "user#001", "sk": "user#001", "name": "Alice", "age": 25}
        self.db.save(item=item, table_name=self.table_name)
    ...
    def test_return_all_old(self):
        ...
        # Create item
        item = {"pk": "user#002", "sk": "user#002", "name": "Bob", "email": "bob@old.com"}
        self.db.save(item=item, table_name=self.table_name)
...
class TestUpdateExpressionsConditional(unittest.TestCase):
    ...
    def test_conditional_update_success(self):
        ...
        # Create item
        item = {"pk": "order#001", "sk": "order#001", "status": "pending", "total": 100}
        self.db.save(item=item, table_name=self.table_name)
        ...
        # Verify update
        response = self.db.get(
            key={"pk": "order#001", "sk": "order#001"}, table_name=self.table_name
        )
    ...
    def test_conditional_update_failure(self):
        ...
        # Create item
        item = {"pk": "account#002", "sk": "account#002", "balance": 50}
        self.db.save(item=item, table_name=self.table_name)
