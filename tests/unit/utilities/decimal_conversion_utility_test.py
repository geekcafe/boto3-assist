...
class TestDecimalConversionUtility(unittest.TestCase):
    ...
    def test_convert_decimals_to_native_types_dict(self):
        ...
        expected = {"price": 19.99, "quantity": 5, "name": "Product A", "active": True}
    ...
    def test_convert_decimals_to_native_types_nested_structure(self):
        ...
        expected = {
            "order": {
                "total": 99.99,
                "items": [{"price": 29.99, "qty": 2}, {"price": 39.99, "qty": 1}],
            },
            "customer_id": "cust_123",
        }
    ...
    def test_convert_native_types_to_decimals_dict(self):
        ...
        input_dict = {"price": 19.99, "quantity": 5, "name": "Product A", "active": True}
    ...
    def test_round_trip_conversion(self):
        ...
        original_data = {
            ...
            "quantities": [1, 2, 3],
            "metadata": {"total": 149.95, "tax": 12.00},
        }
